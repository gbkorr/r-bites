...
Download and install [OBS](https://obsproject.com/) and [FFmpeg](https://www.ffmpeg.org/). Launch OBS and skip the autoconfig wizard (click `Cancel`).
...
___
### 2.2 Usage
Download the files from r-bites' [releases](https://github.com/gbkorr/r-bites/releases) page, or copy the code from the [github](https://github.com/gbkorr/r-bites/tree/main/files). You'll need `webcam.R` and `client.R`.
