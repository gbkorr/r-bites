...
Once the client gets the image, it's time to prepare it to draw. This uses [an engine](/video-player/video-player.qmd) I had already made to render video in the console[^pedigree].
